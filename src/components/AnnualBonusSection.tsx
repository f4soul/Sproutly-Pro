...
export const AnnualBonusSection = ({
  ...
  return (
    <React.Fragment>
       ...
       {/* Total Year Row */}
       <tr className="bg-white/70 dark:bg-black/70 backdrop-blur-2xl font-bold text-light-text-primary dark:text-white align-middle sticky bottom-0 z-10 shadow-[0_-1px_0_0_#e2e8f0] dark:shadow-[0_-1px_0_0_#1e293b] border-t border-slate-200 dark:border-slate-700/50">
