      ...
      return (
        <div className="min-h-screen bg-light-bg dark:bg-dark-bg flex items-center justify-center p-4">
          <div className="apple-card p-8 max-w-md w-full text-center">
            ...
            <h2 className="text-xl font-bold text-light-text-primary dark:text-dark-text-primary mb-2">Произошла ошибка</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-6">{displayMessage}</p>
            <button
              onClick={() => window.location.reload()}
              className="apple-button w-full py-3 px-4 bg-blue-600 text-white"
            >
