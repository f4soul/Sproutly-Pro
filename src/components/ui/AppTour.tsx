  ...
  const assetsSteps = [
    {
      ...
      popover: {
        description: generateHtmlContent(
          ...
          'Активы и Инвестиции',
          <span>Активы разделены на категории. <b>Вклады</b> для банковских счетов, <b>Сейф</b> — наличные или валюта, а <b>Биржа</b> и <b>Крипта</b> — для ценных бумаг и криптовалют с авторасчетом вычетов и актуальных курсов. В настройках можно менять их порядок или скрывать.</span>
        ),
        side: 'bottom',
      }
    },
