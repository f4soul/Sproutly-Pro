...
export function HeatmapLegend({ className }: HeatmapLegendProps) {
  return (
    <div className={cn("w-full flex justify-center shrink-0 mb-4 sm:mb-1 mt-auto", className)}>
      <div className="flex flex-col sm:flex-row items-center justify-center gap-2.5 sm:gap-4 bg-white/60 dark:bg-slate-950/60 px-3 sm:px-4 py-2 sm:py-2.5 rounded-[1rem] sm:rounded-2xl border border-slate-200/80 dark:border-white/[0.08] shadow-sm backdrop-blur-md w-max max-w-full">
        
        {/* Intensity Legend */}
        <div className="flex items-center justify-center gap-1.5 sm:gap-2 sm:border-r border-slate-200 dark:border-white/10 sm:pr-4 shrink-0">
        ...
        {/* Action Legend */}
        <div className="flex items-center gap-4 shrink-0 justify-center border-t border-slate-200/50 dark:border-white/5 pt-2 sm:border-none sm:pt-0 pb-0.5 sm:pb-0 w-full sm:w-auto">
