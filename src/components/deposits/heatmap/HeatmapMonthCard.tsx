...
export const HeatmapMonthCard = React.memo(function HeatmapMonthCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "backdrop-blur-md rounded-panel sm:rounded-card p-3.5 sm:p-4 lg:p-3 xl:p-6 pb-3 sm:pb-3.5 lg:pb-2.5 xl:pb-5 flex flex-col cursor-pointer transition-all group relative",
        hasToday 
              ...
              >
                <span className={cn(
                  ...
                  (day.intensity === 0 
                      ...
                      : "text-white/90"),
                  day.isMaturing && "text-amber-500 dark:text-amber-400/90"
                )}>
                  {day.dayNumber}
                </span>
