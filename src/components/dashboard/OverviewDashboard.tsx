...
export function OverviewDashboard({ deposits, taxSettings, appSettings }: OverviewDashboardProps) {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-700 relative max-w-6xl mx-auto pb-12">
      {/* Header & Year Selector */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">Сводный Дашборд</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">Общая картина доходов и налогов</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="apple-card p-6 lg:col-span-2">
          <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-6">Быстрые действия</h3>
        ...
        <div className="apple-card p-6">
          <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-6">Структура Доходов</h3>
        ...
        <div className="apple-card p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-slate-900 dark:text-white">Налоговый прогноз</h3>
            <div className="text-right">
              <p className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wider">Всего к уплате</p>
        ...
        <div className="apple-card p-6 lg:col-span-2">
          <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-6">Сравнение: Доход и Налог</h3>
