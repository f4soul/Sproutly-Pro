...
import { Wallet, Landmark, Receipt, TrendingUp, ChevronDown, Download, FileText, Image as ImageIcon, FileSpreadsheet } from 'lucide-react';
    ...
    <div className="space-y-6 animate-in fade-in duration-700 relative max-w-7xl mx-auto pb-12">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1 bg-white dark:bg-slate-800 p-1 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm mr-2">
            <button 
              ...
              className="p-2 text-slate-500 hover:text-blue-600 dark:text-slate-400 dark:hover:text-blue-400 hover:bg-slate-50 dark:hover:bg-slate-700 rounded-lg transition-all cursor-pointer"
              title="Экспорт в PDF"
            >
              <FileText size={18} />
            </button>
            <button 
              ...
              className="p-2 text-slate-500 hover:text-emerald-600 dark:text-slate-400 dark:hover:text-emerald-400 hover:bg-slate-50 dark:hover:bg-slate-700 rounded-lg transition-all cursor-pointer"
              title="Экспорт в PNG"
            >
              <ImageIcon size={18} />
            </button>
            <button 
              ...
              className="p-2 text-slate-500 hover:text-green-600 dark:text-slate-400 dark:hover:text-green-400 hover:bg-slate-50 dark:hover:bg-slate-700 rounded-lg transition-all cursor-pointer"
          ...
          <div className="relative group">
            <select
              ...
              className="appearance-none bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 text-sm font-bold rounded-xl pl-4 pr-10 py-2.5 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 cursor-pointer shadow-sm transition-colors hover:bg-slate-50 dark:hover:bg-slate-700/50"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-sm font-bold text-slate-500 dark:text-slate-400">Общий Доход (Gross)</h3>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-sm font-bold text-slate-500 dark:text-slate-400">Чистый Доход (Net)</h3>
          </div>
          <p className="text-2xl font-black text-slate-800 dark:text-slate-100 font-mono">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-sm font-bold text-slate-500 dark:text-slate-400">Всего Налогов</h3>
          </div>
          <p className="text-2xl font-black text-slate-800 dark:text-slate-100 font-mono">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-sm font-bold text-slate-500 dark:text-slate-400">Необлагаемый Лимит</h3>
          </div>
          <p className="text-2xl font-black text-slate-800 dark:text-slate-100 font-mono">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-sm border border-slate-100 dark:border-slate-700/50">
          <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200 mb-6">Структура Доходов</h3>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-sm border border-slate-100 dark:border-slate-700/50">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200">Налоговый прогноз</h3>
            <div className="text-right">
              <p className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Всего к уплате</p>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-sm border border-slate-100 dark:border-slate-700/50 lg:col-span-2">
          <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200 mb-6">Сравнение: Доход и Налог</h3>
