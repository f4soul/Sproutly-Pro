...
export const MonthRow = ({
  ...
  return (
    <tr className="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors group">
      ...
      <td className="px-1 md:px-2 py-1.5 text-right font-mono font-semibold text-blue-700 dark:text-blue-300 bg-blue-50/30 dark:bg-blue-900/10 align-middle text-[11px] lg:text-xs xl:text-sm whitespace-nowrap">
        {formatVal(calcM.gross)}
      </td>
      <td className="px-1 md:px-2 py-1.5 text-right font-mono text-green-700 dark:text-green-300 align-middle text-[11px] lg:text-xs xl:text-sm whitespace-nowrap">
