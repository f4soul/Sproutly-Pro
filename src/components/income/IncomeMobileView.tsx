      ...
      <AnimatePresence>
        {showStickyFooter && (
          <motion.div 
            ...
            className="fixed left-4 right-4 sm:left-6 sm:right-6 xl:hidden z-40 pointer-events-none max-w-2xl mx-auto md:left-[calc(17rem+1.5rem)] md:right-6 income-sticky-analytics-bottom"
          >
